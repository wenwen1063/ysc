...
<body>
    ...
    <div class="pd-20">
        <form action="<?php echo U('/home/adver/adverupdate');?>" name="main_form" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
            <div class="row cl">
            <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                <label class="form-label col-2"><span class="c-red">*</span>广告名称：</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo ($data['ad_name']); ?>" placeholder="输入广告名称" id="ad_name" name="ad_name">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <?php if($data['ad_position']==1): ?><select name="ad_position" class="select" id='ad_position'>
            ...
            <div class="row cl" >
                ...
                <div class="formControls col-4">
                    <span class="select-box">
                 <?php if($data['ad_type']==1): ?><select name="ad_type" class="select" id='ad_type'>
                ...
                <?php if($data['ad_type']==2): ?><select name="ad_type" class="select" id='ad_type'>
                    <option value="2" id='ad_type_link'>链接</option>
                    <option value="3" id='ad_type_link'>商品</option>
                    <option value="1" id='ad_type_content' style="display:none">内容</option>
                </select>
                    <!--<option value="1" id='ad_type_content' style="display:none">内容</option>--><?php endif; ?>

                <?php if($data['ad_type']==3): if($data['ad_position']==1): ?><select name="ad_type" class="select" id='ad_type'>
                            <option value="3" id='ad_type_link'>商品</option>
                            <option value="2" id='ad_type_link'>链接</option>
                            <option value="1" id='ad_type_content' style="display:none">内容</option>
                        </select>
            ...
            <div class="row cl" id='row_ad_link' <?php if($data['ad_type'] != 2){echo "style='display:none'";}?> >
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo ($data['ad_link']); ?>" placeholder="输入广告链接" id="ad_link" name="ad_link1">
                </div>
            </div>
            ...
            <div class="row cl" id='row_ad_goods' <?php if($data['ad_type'] != 3){echo "style='display:none'";}?>>
                ...
                <div class="formControls col-4">
                    <!--<input type="text" class="input-text" value="<?php echo ($data['ad_link']); ?>" placeholder="输入商品链接" id="ad_goods" name="ad_link2">-->

                    <select class="goods" size="" name="goods" id="seller_select">
                        <option value="<?php echo ($ad_goods['goods_id']); ?>"><?php echo ($ad_goods['goods_name']); ?></option>
                        <?php if(is_array($goods)): foreach($goods as $key=>$v): ?><option value="<?php echo ($v['g_id']); ?>"><?php echo ($v['g_name']); ?></option><?php endforeach; endif; ?>
                    </select>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo ($data['ad_sort']); ?>" placeholder="输入广告名称" id="ad_sort" name="ad_sort">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5" style="width:10%;">
                    ...
                    <p id="smtext" class="sm_logo">
                        <img id="smlogo" name="smlogo" higth="100" width="100" src="/ysc2/Public/Uploads/<?php echo ($data['img']); ?>" />
                    </p>
                </div>
                <div class="col-4"> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-5" style="width:10%;">
                    ...
                    <p></p>
                    <p id="smtext" class="sm_logo">
                        <img id="smlogo2" name="smlogo2" higth="100" width="100" src="/ysc2/Public/Uploads/<?php echo ($data['img2']); ?>" />
                    </p>
                </div>
                <div class="col-4"> </div>
            </div>
