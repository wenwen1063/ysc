...
<div class="pd-20">
    <form action="<?php echo U('/home/goodsclasstwo/goodsclasstwoindex/search/');?>" method="post/get" name="main_form" class="form form-horizontal" id="form-admin-add" style="float:right;">
        <div class="text-c">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
        <a href="<?php echo U('/home/goodsclasstwo/goodsclasstwoadd');?>" class="btn btn-primary radius"> 新增 </a></span>&nbsp;
        <span class="r">共有数据：<strong><?php echo ($count); ?></strong> 条</span> </div>
    <table class="table table-border table-bordered table-bg">
        <thead>
            <tr>
                <th scope="col" colspan="8">分类列表</th>
            </tr>
            <tr class="text-c">
                <th width="40">操作</th>
                <th width="40">编号</th>
        ...
        <tbody>
            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="text-c">
                    ...
                    <a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/goodsclasstwo/goodsclasstwodisable',array('id'=>$v['id'],'is_disable'=>$v['is_disable']));?>">禁用</a>
                    <?php else: ?>
                    <a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/goodsclasstwo/goodsclasstwodisable',array('id'=>$v['id'],'is_disable'=>$v['is_disable']));?>">启用</a>
                    <?php endif ?>
                    <a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/goodsclasstwo/goodsclasstwoupdate',array('id'=>$v['id']));?>">编辑</a>
                    <a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/goodsclasstwo/goodsclasstwodel',array('id'=>$v['id']));?>" onclick="return confirm('确认要删除吗？');">删除</a>
                    </td>
                    <td><?php echo ($v['number']); ?></td>
                    <td><?php echo ($v['name']); ?></td>
                    <td><?php echo ($v['gc_name']); ?></td>
                    <td width="40"><img height="30" src="/ysc2/Public/Uploads/<?php echo ($v['big_pic']); ?>"></td>
                    <td width="40"><img height="30" src="/ysc2/Public/Uploads/<?php echo ($v['sm_pic']); ?>"></td>
                    <?php if ($v['is_disable']==0): ?>
