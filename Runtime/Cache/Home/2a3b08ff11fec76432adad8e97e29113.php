...
<div class="pd-20">
	<form action="<?php echo U('/home/logclass/logclassindex/search/');?>" method="post/get" name="main_form" class="form form-horizontal" id="form-admin-add" style="float:right;">
		<div class="text-c">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a href="<?php echo U('/home/logclass/logclassadd');?>" class="btn btn-primary radius"> 新增 </a></span>&nbsp;
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="text-c">
					...
					<a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/logclass/logclassdisable',array('id'=>$v['id'],'is_disable'=>$v['is_disable']));?>">禁用</a>
					<?php else: ?>
					<a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/logclass/logclassdisable',array('id'=>$v['id'],'is_disable'=>$v['is_disable']));?>">启用</a>
					<?php endif ?>
					<a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/logclass/logclassupdate',array('id'=>$v['id']));?>">编辑</a>
					<a class="btn btn-primary size-MINI radius" href="<?php echo U('/home/logclass/logclassdel',array('id'=>$v['id']));?>" onclick="return confirm('确认要删除吗？');">删除</a>
					</td>
					<td><?php echo ($v['sn']); ?></td>
					<td><?php echo ($v['name']); ?></td>
					<td><?php echo ($v['interface']); ?></td>
					<?php if ($v['is_disable']==0): ?>
